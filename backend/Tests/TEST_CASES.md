...
### 41. Test Case ID: TC_Complaint_30
**Title:** Submit Fraud Type Complaint  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Select "Fraud" as complaint type
- Fill other required fields
- Click 'Submit' button

**Test Data:**
- Complaint Type: `Fraud`
- Description: `I was scammed online through a fake website`

**Expected Result:** 
- Returns status 200
- Complaint is created with "Fraud" category
- Category ID is correctly mapped

---

### 42. Test Case ID: TC_Complaint_31
**Title:** Database Error During Complaint Submission  
**Precondition:** User is authenticated; database connection fails.  
**Steps:**
- Login with valid credentials
...
### 43. Test Case ID: TC_Complaint_32
**Title:** Submit Complaint with Valid Date Format (YYYY-MM-DD)  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
...
### 44. Test Case ID: TC_Complaint_33
**Title:** Submit Complaint with DateTime Format  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter date with time (YYYY-MM-DD HH:MM:SS)
- Fill other fields
- Click 'Submit' button

**Test Data:**
- Incident Date: `2026-01-15 14:30:00`
- Complaint Type: `Theft`

**Expected Result:** 
- Returns status 200
- DateTime format is accepted
- Date and time are stored correctly

---

### 45. Test Case ID: TC_Complaint_34
**Title:** Submit Complaint with Extremely Long Description  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter very long description (>10000 characters)
- Fill other fields
- Click 'Submit' button

**Test Data:**
- Description: String of 10000+ characters

**Expected Result:** 
- Returns status 400
- Response contains error message: "Description too long"
- Complaint is not created

---

### 46. Test Case ID: TC_Complaint_35
**Title:** Submit Complaint with Special Characters in Description  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter description with special characters
- Fill other fields
- Click 'Submit' button

**Test Data:**
- Description: `Stolen! @#$%^&*() items: laptop, phone & wallet`

**Expected Result:** 
- Returns status 200
- Special characters are handled correctly
- Description is stored with special characters

---

### 47. Test Case ID: TC_Complaint_36
**Title:** Submit Complaint with HTML Tags in Description  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter description with HTML tags
- Fill other fields
- Click 'Submit' button

**Test Data:**
- Description: `<script>alert('test')</script> My car was stolen`

**Expected Result:** 
- Returns status 200
- HTML tags are sanitized or escaped
- No script execution occurs
- Complaint is created safely

---

### 48. Test Case ID: TC_Complaint_37
**Title:** Submit Multiple Complaints from Same User  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Submit first complaint
- Submit second complaint immediately
- Submit third complaint

**Test Data:**
- User: Same user for all complaints
- Different complaint details for each

**Expected Result:** 
- All complaints are created successfully
- Each complaint has unique ID
- User can submit multiple complaints
- No conflicts or errors occur

---

### 49. Test Case ID: TC_Complaint_38
**Title:** Submit Complaint with Very Long Location Name  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter very long location address
- Fill other fields
- Click 'Submit' button

**Test Data:**
- Location: String of 500+ characters

**Expected Result:** 
- Returns status 200 or 400 based on validation
- If accepted, location is stored correctly
- If rejected, appropriate error message is shown

---

### 50. Test Case ID: TC_Complaint_39
**Title:** Submit Complaint with Unicode Characters in Location  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter location with unicode characters
- Fill other fields
- Click 'Submit' button

**Test Data:**
- Location: `市中心区北京路123号` (Chinese characters)

**Expected Result:** 
- Returns status 200
- Unicode characters are handled correctly
- Location is stored with proper encoding

---

### 51. Test Case ID: TC_Complaint_40
**Title:** Submit Complaint with Non-Numeric Latitude  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
...
**Expected Result:** 
- Returns status 400
- Response contains error message: "Latitude must be a number"
- Complaint is not created

---

### 52. Test Case ID: TC_Complaint_41
**Title:** Submit Complaint with Missing Longitude When Latitude Provided  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Navigate to complaint submission page
- Enter latitude but leave longitude empty
- Fill other fields
- Click 'Submit' button
...
**Expected Result:** 
- Returns status 400
- Response contains error message: "Both latitude and longitude required"
- Complaint is not created

---

### 53. Test Case ID: TC_Complaint_42
**Title:** Handle Admin Assignment Failure Gracefully  
**Precondition:** User is authenticated; admin assignment system fails.  
**Steps:**
- Login with valid credentials
- Simulate admin assignment failure
- Attempt to submit complaint

**Test Data:**
- Location with admin assignment error

**Expected Result:** 
- Returns status 400 or 500
- Appropriate error message is returned
- Complaint is not created or marked for manual assignment

---

### 54. Test Case ID: TC_Complaint_43
**Title:** Handle Location Creation Failure  
**Precondition:** User is authenticated; location creation fails.  
**Steps:**
- Login with valid credentials
- Enter new location
- Simulate location creation failure
- Attempt to submit complaint
...
### 55. Test Case ID: TC_Complaint_44
**Title:** Handle Category Lookup Failure  
**Precondition:** User is authenticated; category lookup fails.  
**Steps:**
- Login with valid credentials
- Select complaint type
- Simulate category lookup failure
- Attempt to submit complaint
...
### 56. Test Case ID: TC_Complaint_45
**Title:** Submit Complaint with Expired Session  
**Precondition:** User was authenticated but session expired.  
**Steps:**
- Login with valid credentials
...
**Expected Result:** 
- Returns status 401
- Response contains error message: "Session expired"
- User is redirected to login page
- Complaint is not created

---

### 57. Test Case ID: TC_Complaint_46
**Title:** Handle Tampered Session Data  
**Precondition:** User is authenticated.  
**Steps:**
- Login with valid credentials
- Modify session data (userId) manually
- Attempt to submit complaint

**Test Data:**
- Tampered userId in session

**Expected Result:** 
- Returns status 401 or 403
- Response contains error message: "Invalid session"
- Complaint is not created
- Security validation prevents malicious access
